      ...
      <div className="bg-emerald-900 h-25 w-full">
        <div className="max-w-7xl mx-auto h-full flex items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center w-full justify-between">
            <div className="text-white text-[18px] items-center space-x-2 sm:space-x-4 lg:space-x-10 flex">
              ...
              <div className="hidden lg:flex items-center space-x-10">
                {menuItems.map((menu) => (
                  ...
                  href={menu.link}
                    key={menu.name}
                    className="hover:text-black duration-500 transition-all group px-3 py-1 cursor-pointer relative rounded-2xl hover:bg-white"
                  >
                    {menu.name}
            ...
            <div className="hidden sm:flex text-[18px] space-x-4">
              ...
              <button className="text-white duration-500 transition-all rounded-full p-3 lg:block hidden hover:text-black hover:bg-white">
                Sign in
              </button>
            </div>
